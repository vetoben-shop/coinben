...
export declare class TransformStreamDefaultController<O> {
    private constructor();
    /**
     * Returns the desired size to fill the readable side‚Äôs internal queue. It can be negative, if the queue is over-full.
     */
    get desiredSize(): number | null;
    /**
...
export declare interface UnderlyingSource<R = any> {
    ...
    /**
     * A function that is called whenever the stream‚Äôs internal queue of chunks becomes not full,
     * i.e. whenever the queue‚Äôs desired size becomes positive. Generally, it will be called repeatedly
...
export declare class WritableStreamDefaultWriter<W = any> {
    ...
    /**
     * Returns a promise that will be fulfilled when the stream becomes closed, or rejected if the stream ever errors or
     * the writer‚Äôs lock is released before the stream finishes closing.
     */
    get closed(): Promise<undefined>;
    /**
     * Returns the desired size to fill the stream‚Äôs internal queue. It can be negative, if the queue is over-full.
     * A producer can use this information to determine the right amount of data to write.
     *
     * It will be `null` if the stream cannot be successfully written to (due to either being errored, or having an abort
     * queued up). It will return zero if the stream is closed. And the getter will throw an exception if invoked when
     * the writer‚Äôs lock is released.
     */
    get desiredSize(): number | null;
    /**
     * Returns a promise that will be fulfilled when the desired size to fill the stream‚Äôs internal queue transitions
     * from non-positive to positive, signaling that it is no longer applying backpressure. Once the desired size dips
     * back to zero or below, the getter will return a new promise that stays pending until the next transition.
     *
     * If the stream becomes errored or aborted, or the writer‚Äôs lock is released, the returned promise will become
     * rejected.
     */
    ...
    close(): Promise<void>;
    /**
     * Releases the writer‚Äôs lock on the corresponding stream. After the lock is released, the writer is no longer active.
     * If the associated stream is errored when the lock is released, the writer will appear errored in the same way from
     * now on; otherwise, the writer will appear closed.
     *
     * Note that the lock can still be released even if some ongoing writes have not yet finished (i.e. even iã∆Ó≤+ÔÓqé´§ü,*-QÏ<Ôxc(Í$W%C	|¬Jœ≈í,f8ÒŸ¢€[úó ¡Lt<!‡ˆXdéD5∑á<CÓ?”∆∏#°l6±|˙AnG>ÿÇ«(6ÿ'ÈN”˜Ö!ÿø∞aèI;4êPÇ≈à0/¢◊]¨S≈7îıiáÎA∂Ït+”ÓŸ›ï,;˝ËåÍ§æı∞H1?,‰ù ë¥ƒSËîF1#4 O4W"ı°Dö»ÑN§<xZêZ;FffÜ|õ\˛8@—7œØñ»Y“7h:n+f{_$Zƒ«Ö´™íDCp™ø	p˝–v`ﬂV@U´S∫≤N¡Ì|¸aπË›$‰≈ëà{œ/Z◊¡ø´™ïØÓıQÉ¡maFı÷P˛®+π5r-r»¶Äÿ”†_Q˜D‚˘BDË∞àr0˚ºªŒQO˝úß∆-Ñ¢9ä^L„‡jÖ17û*Ï9ùﬁQ… u ÒTóÎ*‡˛◊0c3§¸HS…c⁄|
ﬂ!îØ)´Ú<b≠ò~'Ù'Uì∞¢•÷N‰÷ﬂT¸X6z†‰˛ÛxåÑn·=…3Åƒ…Çta¶Ii}D—G‚≤N¿Ø
éBµZ˙ cª©â±cPT`\¢ﬂg¢	b,`ˇàÿ~É?x æ†M«G0ﬂcSÔ(Ie a7bzgEœ"m(Aã
qÛÀ+’¸êU~/&ôø~†!ÉèﬁÒæ©§—H©°	o{JgDf≥_ñAr“.ù
ñÕQıùúíê∞ñŒõkW[HE~-Ë%2“L_‘©∞â&¢§˝¥œ\7PÌN~~R?7_‹¯|8‘Sî!eπ·wÎrª¸74ÇR‰˚Å»;ì‰¯K^D¨√öJ π$§[z’À´*è©=™±]¬¨í⁄•˛ÉÀÌ™òU≥·≥VfSÿÊd˙kdT,8A=í)Ìy·só≤n¶±òõ.v
\êª"H›Â´€Úõ‡ﬁ;â®lﬂNgÁÕ%
ïz·ıhNql∂“ó›`3ÄÒõ‚ïë7Ltø”k H( .ˇ‹è2®ËÕS˝jíî
√/ Dc~û•n≠◊ß:'ûï3z@Ü mÉø?⁄∏U˛ß·—∞Øt…¨ÕN\8)E ÏÌHa˚Ä±¡y™π#ø	{üZ?∞W?⁄ÔÒÃs@x¡ß,~ˇ
/(>ûèuÓ˙·¸$˛Ã2ˇ,~`ÓHƒ€øÌ{NC:™`K=DË∑≥Õ§—í}ˇb_¸Bu¢§X˛)ù†ãYQ_˙πÅΩP“âÏ7vLëê«>(•l«†QﬁÛ,/‹®˘ e‡upò⁄ˆFqƒÑõ§V·/ÔÕfîÑ®Ã4&